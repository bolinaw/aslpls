...
namespace eval ::AIChat {
    # --- CONFIGURATION ---
    variable apiKey "YOUR-API-KEY-HERE" #groq.com (API)
    variable apiUrl "https://api.groq.com/openai/v1/chat/completions"
    
    # FIXED: Updated to production-supported Llama 3.3 model to fix HTTP 400 error
    variable model "llama-3.3-70b-versatile"
